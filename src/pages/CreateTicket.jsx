  ...
  return (
    <AppLayout>
      ...
      <form>
        ...
        {/* Type */}
        <div className="mb-4">
          <label className="block mb-2 font-medium" htmlFor="type">Type</label>
          <select
            className="w-full p-2 rounded"
            id="type"
            name="type"
        ...
        {/* Priority */}
        <div className="mb-4">
          <label className="block mb-2 font-medium" htmlFor="priority">Priority</label>
          <select
            className="w-full p-2 rounded"
            id="priority"
            name="priority"
        ...
        {/* Language */}
        <div className="mb-4">
          <label className="block mb-2 font-medium" htmlFor="language">Language</label>
          <select
            className="w-full p-2 rounded"
            id="language"
            name="language"
        ...
        {formfields.map((field) => (
          <div className="mb-4" key={field.id}>
            <label className="block mb-2 font-medium" htmlFor={field.id}>{field.label}</label>
            {field.type === 'textarea' ? (
              <textarea
                className="w-full p-2 rounded"
                id={field.id}
        ...
        <div className="flex items-center gap-2">
          ...
          <a className="secondary-btn px-4 py-2 rounded cursor-pointer" href="/">Back</a>
        </div>
      </form>
    </AppLayout>
  )
